"""Generate 2D U(1) gauge configurations with standard HMC."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate 2D U(1) gauge configurations")
...
def main() -> None:
    ...
    np.save(gauge_dir / f"theta_L{args.lattice_size}_beta{beta_tag}{output_suffix}.npy", np.asarray(configs))
